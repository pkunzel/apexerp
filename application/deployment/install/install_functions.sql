...
wwv_flow_imp_shared.create_install_script(
 p_id=>wwv_flow_imp.id(65378753861122492529)
...
'    IF v_cpf = ''00000000000'' OR v_cpf = ''11111111111'' OR v_cpf = ''22222222222'' OR v_cpf = ''33333333333'' OR v_cpf = ''44444444444'' OR v_cpf = ''55555555555'' OR v_cpf = ''66666666666'' OR v_cpf = ''77777777777'' OR v_cpf = ''88888888888'' OR v_cpf = ''999999999'
||'99'' THEN',
'        RETURN FALSE;',
'    END IF;',
'',
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(65378753939650492532)
,p_script_id=>wwv_flow_imp.id(65378753861122492529)
,p_object_owner=>'#OWNER#'
,p_object_type=>'FUNCTION'
,p_object_name=>'FCN_VALIDACNPJ'
,p_last_updated_by=>'ARNETO'
,p_last_updated_on=>to_date('20240214121726','YYYYMMDDHH24MISS')
,p_created_by=>'ARNETO'
,p_created_on=>to_date('20240214121726','YYYYMMDDHH24MISS')
);
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(65378754189354492533)
,p_script_id=>wwv_flow_imp.id(65378753861122492529)
,p_object_owner=>'#OWNER#'
,p_object_type=>'FUNCTION'
,p_object_name=>'FCN_VALIDAR_CPF'
,p_last_updated_by=>'ARNETO'
,p_last_updated_on=>to_date('20240214121726','YYYYMMDDHH24MISS')
,p_created_by=>'ARNETO'
,p_created_on=>to_date('20240214121726','YYYYMMDDHH24MISS')
