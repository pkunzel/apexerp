...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(62607205746659989558)
,p_theme_id=>42
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62607206032384989558)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62607206341550989559)
,p_page_template_id=>wwv_flow_imp.id(62607205746659989558)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62607206693670989559)
,p_page_template_id=>wwv_flow_imp.id(62607205746659989558)
