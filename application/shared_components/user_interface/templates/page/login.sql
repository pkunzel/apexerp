...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(62607216912896989564)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62607217263114989564)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62607217546108989564)
,p_page_template_id=>wwv_flow_imp.id(62607216912896989564)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62607217890879989565)
,p_page_template_id=>wwv_flow_imp.id(62607216912896989564)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62607218144673989565)
,p_page_template_id=>wwv_flow_imp.id(62607216912896989564)
,p_name=>'Body Footer'
