...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(62607226958701989569)
,p_theme_id=>42
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62607227206325989569)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62607227515149989569)
,p_page_template_id=>wwv_flow_imp.id(62607226958701989569)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62607227829989989570)
,p_page_template_id=>wwv_flow_imp.id(62607226958701989569)
