...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(62607242239143989576)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62607242532796989576)
,p_plug_template_id=>wwv_flow_imp.id(62607242239143989576)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62607242877828989577)
,p_plug_template_id=>wwv_flow_imp.id(62607242239143989576)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62607243192533989577)
,p_plug_template_id=>wwv_flow_imp.id(62607242239143989576)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62607243471057989577)
,p_plug_template_id=>wwv_flow_imp.id(62607242239143989576)
,p_name=>'Sub Regions'
