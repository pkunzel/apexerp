...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(62607243687060989577)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62607243949352989577)
,p_plug_template_id=>wwv_flow_imp.id(62607243687060989577)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62607244208362989577)
,p_plug_template_id=>wwv_flow_imp.id(62607243687060989577)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62607244593558989577)
,p_plug_template_id=>wwv_flow_imp.id(62607243687060989577)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62607244862991989577)
,p_plug_template_id=>wwv_flow_imp.id(62607243687060989577)
,p_name=>'Sub Regions'
