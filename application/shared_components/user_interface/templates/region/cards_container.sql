...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(62607249310192989579)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62607249614914989579)
,p_plug_template_id=>wwv_flow_imp.id(62607249310192989579)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62607249917784989579)
,p_plug_template_id=>wwv_flow_imp.id(62607249310192989579)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62607250247864989579)
,p_plug_template_id=>wwv_flow_imp.id(62607249310192989579)
,p_name=>'Sub Regions'
