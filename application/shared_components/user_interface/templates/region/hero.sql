...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(62607275594540989590)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62607275881939989590)
,p_plug_template_id=>wwv_flow_imp.id(62607275594540989590)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62607276175594989590)
,p_plug_template_id=>wwv_flow_imp.id(62607275594540989590)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62607276417942989590)
,p_plug_template_id=>wwv_flow_imp.id(62607275594540989590)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62607276718658989590)
,p_plug_template_id=>wwv_flow_imp.id(62607275594540989590)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62607277094741989590)
,p_plug_template_id=>wwv_flow_imp.id(62607275594540989590)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
