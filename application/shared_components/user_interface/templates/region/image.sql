...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(62607279034571989591)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62607279307095989591)
,p_plug_template_id=>wwv_flow_imp.id(62607279034571989591)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62607279639476989591)
,p_plug_template_id=>wwv_flow_imp.id(62607279034571989591)
,p_name=>'Sub Regions'
