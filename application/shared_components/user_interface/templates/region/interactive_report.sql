...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(62607299016293989599)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62607299327655989599)
,p_plug_template_id=>wwv_flow_imp.id(62607299016293989599)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62607299627666989599)
,p_plug_template_id=>wwv_flow_imp.id(62607299016293989599)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62607299931205989599)
,p_plug_template_id=>wwv_flow_imp.id(62607299016293989599)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62607300204552989599)
,p_plug_template_id=>wwv_flow_imp.id(62607299016293989599)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62607300567420989600)
,p_plug_template_id=>wwv_flow_imp.id(62607299016293989599)
,p_name=>'Sub Regions'
