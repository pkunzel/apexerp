...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(62607301109895989600)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62607301493689989600)
,p_plug_template_id=>wwv_flow_imp.id(62607301109895989600)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62607301715987989600)
,p_plug_template_id=>wwv_flow_imp.id(62607301109895989600)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62607302008718989600)
,p_plug_template_id=>wwv_flow_imp.id(62607301109895989600)
,p_name=>'Button Start'
