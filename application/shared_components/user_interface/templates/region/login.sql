...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(62607303680459989601)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62607303922475989601)
,p_plug_template_id=>wwv_flow_imp.id(62607303680459989601)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62607304250236989601)
,p_plug_template_id=>wwv_flow_imp.id(62607303680459989601)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62607304571317989601)
,p_plug_template_id=>wwv_flow_imp.id(62607303680459989601)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62607304885338989601)
,p_plug_template_id=>wwv_flow_imp.id(62607303680459989601)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62607305178767989601)
,p_plug_template_id=>wwv_flow_imp.id(62607303680459989601)
,p_name=>'Sub Regions'
