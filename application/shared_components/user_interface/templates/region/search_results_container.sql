...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(62607306113933989602)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62607306405578989602)
,p_plug_template_id=>wwv_flow_imp.id(62607306113933989602)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62607306770285989602)
,p_plug_template_id=>wwv_flow_imp.id(62607306113933989602)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62607307022089989602)
,p_plug_template_id=>wwv_flow_imp.id(62607306113933989602)
,p_name=>'Sub Regions'
