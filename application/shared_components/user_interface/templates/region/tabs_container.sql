...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(62607318624189989607)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62607318972859989607)
,p_plug_template_id=>wwv_flow_imp.id(62607318624189989607)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62607319284709989607)
,p_plug_template_id=>wwv_flow_imp.id(62607318624189989607)
,p_name=>'Tabs'
