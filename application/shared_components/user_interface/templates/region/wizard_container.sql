...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(62607326377418989610)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62607326655142989610)
,p_plug_template_id=>wwv_flow_imp.id(62607326377418989610)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62607326955232989610)
,p_plug_template_id=>wwv_flow_imp.id(62607326377418989610)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62607327203224989610)
,p_plug_template_id=>wwv_flow_imp.id(62607326377418989610)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62607327517010989610)
,p_plug_template_id=>wwv_flow_imp.id(62607326377418989610)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(62607327864221989610)
,p_plug_template_id=>wwv_flow_imp.id(62607326377418989610)
