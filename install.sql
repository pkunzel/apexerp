...
@@application/shared_components/files/script_jquery_mask_min_js.sql
...
@@application/shared_components/user_interface/lovs/erp_cargo_funcionario_descricao.sql
@@application/shared_components/user_interface/lovs/erp_estado_nome.sql
@@application/shared_components/user_interface/lovs/erp_filial_nome.sql
@@application/shared_components/user_interface/lovs/erp_funcionario_nome.sql
@@application/shared_components/user_interface/lovs/sim_nao.sql
...
@@application/deployment/install/install_tabelas.sql
@@application/deployment/install/install_triggers.sql
@@application/deployment/install/install_index.sql
